...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    comment_id   BIGINT      NULL COMMENT '关联评论 ID；点赞/收藏/关注通知为空',
    comment_content VARCHAR(255) NULL COMMENT '评论摘要；普通互动通知为空',
    type         VARCHAR(16) NOT NULL COMMENT '通知类型：like=点赞 / favorite=收藏 / follow=关注 / comment=评论 / reply=回复',
